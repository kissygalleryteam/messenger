 ...
 */
KISSY.add('gallery/messenger/1.0/index', function(S, DOM, Event, UA, JSON, SWF) {
		...
		var	win = window,
			...
			// 为了兼容调试和线上
			postMessageSwf = VERSION ? ( 'http://a.tbcdn.cn/kissy/gallery/messenger/1.0/flash-post-message.swf' ) :'flash-post-message.swf',
